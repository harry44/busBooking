...
<!-- //meta-tags -->
<link href="${resource(dir:'assets/css',file:'bootstrap.css') }" rel="stylesheet" type="text/css" media="all" />
<link href="${resource(dir:'assets/css',file:'font-awesome.css') } rel="stylesheet"> 
<link rel="stylesheet" href="${resource(dir:'assets/css',file:'owl.carousel.css') }" type="text/css" media="all"/> <!-- Owl-Carousel-CSS -->
<link rel="stylesheet" href="${resource(dir:'assets/css',file:'flexslider.css') }" type="text/css" media="screen" property="" />
<link href="${resource(dir:'assets/css',file:'style.css') }" rel="stylesheet" type="text/css" media="all" />
<link rel="stylesheet" href="${resource(dir:'assets/css',file:'lightbox.css') }">
<!--web-fonts-->
...
<!-- //Footer -->
<script src="${resource(dir:'assets/js',file:'jquery-2.2.3.min.js') }"></script> 

					<script src="${resource(dir:'assets/js',file:'lightbox-plus-jquery.min.js') }"></script>	
			<!-- Owl-Carousel-JavaScript -->
	<script src="${resource(dir:'assets/js',file:'move-top.js') }owl.carousel.js"></script>
	<script>
	...
	<!-- //Owl-Carousel-JavaScript -->  
	<!-- flexSlider -->
					<script defer src="${resource(dir:'assets/js',file:'jquery.flexslider.js') }"></script>
				...
				<!-- //flexSlider -->
 <!-- Move-top-scrolling -->
<script type="text/javascript" src="${resource(dir:'assets/js',file:'move-top.js') }"></script>
<script type="text/javascript" src="${resource(dir:'assets/js',file:'easing.js') }"></script>
<script type="text/javascript">
...
<!-- Move-top-scrolling -->
<!-- Calendar -->
				<link rel="stylesheet" href="${resource(dir:'assets/css',file:'jquery-ui.css') }" />
				<script src="${resource(dir:'assets/js',file:'jquery-ui.js') }"></script>
				  <script>
						  $(function() {
